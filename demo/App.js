...
import BoxBlurFilter from '../index.js';
...
export default class App {
  constructor(options) {
    ...
    var boxBlurFilter = new BoxBlurFilter(4, resize.width, resize.height);

    this.gui = new dat.GUI();
    this.gui.add(boxBlurFilter, 'deltaX', -32, 32).step(0.1).listen();
    this.gui.add(boxBlurFilter, 'deltaY', -32, 32).step(0.1).listen();
    this.gui.add(boxBlurFilter, 'delta', -32, 32).step(0.1).listen();

    this.scene.filters = [boxBlurFilter];
